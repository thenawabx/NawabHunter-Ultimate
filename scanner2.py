...
def process_recon(target, flags):
    ...
    nuclei_base = f"nuclei -t {t_path} -rl 6 -c 3 {flags}" if os.path.exists(t_path) else f"nuclei -rl 6 -c 3 {flags}"
    tasks = [
        ...
        ("4.6 Katana Urls", "urls/katana_urls.txt", "vulnerability/katana_urls.txt", False)
    ]
